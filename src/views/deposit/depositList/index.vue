<template>
  <div class="container">
    ...
    <!-- dialog -->
    <addDepositDialog :dialog="dialog" @upData="getData"></addDepositDialog>
    <!-- 设置dialog -->
    <guaranteeDialog :guaranteeDialogs="guaranteeDialogs"></guaranteeDialog>
  </div>
</template>
<script>
import GuaranteeDialog from "@/components/deposit/guaranteeDialog";
import AddDepositDialog from "@/components/deposit/addDepositDialog";
...
export default {
  components: {
    ...
    addDepositDialog: AddDepositDialog,
