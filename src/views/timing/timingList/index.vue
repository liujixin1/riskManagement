<template>
  <div class="container">
    ...
    <!-- dialog -->
    <addTimingDialog :dialog="dialog" @upData="getData"></addTimingDialog>
    <!-- 设置dialog -->
    <guaranteeDialog :guaranteeDialogs="guaranteeDialogs"></guaranteeDialog>
  </div>
</template>
<script>
import AddTimingDialog from "@/components/timing/addTimingDialog";
import GuaranteeDialog from "@/components/timing/guaranteeDialog";
import Pagination from "@/components/pagination";
import { getTimingList, delGroup } from "@/api/timing/timingList";
export default {
  components: {
    pagination: Pagination,
    addTimingDialog: AddTimingDialog,
