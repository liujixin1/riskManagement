<template>
  <div class="container">
    ...
    >
      ...
      <!-- <el-table-column prop="id_str" label="用户平仓" align="center"></el-table-column>
      ...
      <el-table-column prop="all_profit_buy_count" label="买涨" align="center"></el-table-column>
      <el-table-column prop="all_loss_buy_count" label="买跌" align="center"></el-table-column>
...
import {sells,buyListCollectByGood } from "@/api/riskMonitoring/position";
export default {
  components: {
