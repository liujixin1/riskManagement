<template>
  <div class="container">
    ...
    <!-- dialog -->
    <addPositionDialog :dialog="dialog" @upData="getData"></addPositionDialog>
    <!-- 设置dialog -->
    <guaranteeDialog :guaranteeDialogs="guaranteeDialogs"></guaranteeDialog>
  </div>
</template>
<script>
import AddPositionDialog from "@/components/position/addPositionDialog";
import GuaranteeDialog from "@/components/position/guaranteeDialog";
import Pagination from "@/components/pagination";
import { getPositionList, delGroup } from "@/api/position/positionList";
export default {
  components: {
